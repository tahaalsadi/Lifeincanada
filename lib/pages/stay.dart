...
class _StayState extends State<Stay> {
  ...
  List<Stayy> filteredStay = []; 

  @override
   void initState() {
    /////////5
    super.initState();
     StayService.getStay().then((stayFromServer) {
      setState(() {
        stay = stayFromServer;
        filteredStay = stay;
      });
                    ...
                    child: CustomElevation(
                     ...
                     child:Column(
                          ...
                          Expanded(
                            child:  DraggableScrollbar.semicircle(
                              ...
                              child: ListView.builder(
                                          ...
                                          itemCount: filteredStay.length,
                                          itemBuilder: (context, index) {
                                            var imageurl = filteredStay[index].imageUrl;
                                            ...
                                            return Card(
                                              ...
                                              child: Column(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Text(
                                                    filteredStay[index].author_info,
                                                  ),
                                                  Text(
                                                    filteredStay[index].date,
                                                  ),
                                                ],
                                              ),
                                            ));
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: Colors.white,
                        boxShadow: [
                          BoxShadow(color:Color.fromRGBO(28, 195, 178, 0.9), spreadRadius: 2),
                        ],
                      ),
                      height: (MediaQuery.of(context).size.height),
                    ),
          ...
          /////////////////////////
                 ...
                 const Positioned(
                    ...
                    child: Padding(
                      ...
                      child: Center(child: Text('الأستقرار في كندا',style:  TextStyle(fontSize: 25,color: Colors.black, fontFamily: 'el-messiri-cufonfonts',),textDirection: TextDirection.rtl,))
                    )
                ),                                       
                    ],
                  ),
