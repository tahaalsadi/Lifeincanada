...
import 'package:lifeincanadalast/servises/house_services.dart';
import 'package:lifeincanadalast/static/main_darwer.dart';
import 'package:readmore/readmore.dart';
class House extends StatefulWidget {
  static const route = '/House';
...
class _HouseState extends State<House> {
  ...
  void initState() {
    ...
    HouseService.getHouse().then((houseFromServer) {
      setState(() {
        house = houseFromServer;
        filteredHouse = house;
      });
    });
  }
                        ...
                        padding: const EdgeInsets.only(bottom: 2.0),
                          child:CustomPaint(
                            ...
                            child: Container(
                              ...
                              child: const Center(child: Text("أخبار ومواضيع",style: TextStyle(fontSize: 40,color: Colors.white,fontFamily: 'el-messiri-cufonfonts',
                            ...
                            child:  DraggableScrollbar.semicircle(
                              ...
                              child: ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            ...
                                            var imageurl = filteredHouse[index].imageUrl;
                                            ...
                                            return Card(
                                              ...
                                              child: Column(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Text(
                                                    filteredHouse[index].author_info,
                                                  ),
                                                  Text(
                                                    filteredHouse[index].date,
                                                  ),
                                                ],
                                              ),
                                            )
          ...
          /////////////////////////
                 ...
                 const Positioned(
                    ...
                    child: Padding(
                      ...
                      child:Center(child: Text('السكن والإقامة',style:  TextStyle(fontSize: 25,color: Colors.black, fontFamily: 'el-messiri-cufonfonts',),textDirection: TextDirection.rtl,))
                    )
                ),                                       
                    ],
                  ),
