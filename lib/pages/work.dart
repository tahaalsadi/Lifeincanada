...
import 'package:lifeincanadalast/servises/work_services.dart';
...
class _WorkState extends State<Work> {
  ...
  void initState() {
    ...
    WorkService .getWork()!.then((workFromServer) {
      setState(() {
        work = workFromServer;
        filteredWork = work;
      });
                              ...
                              Expanded(
                                child:  DraggableScrollbar.semicircle(
                                  ...
                                  child: ListView.builder(
                                      ...
                                      itemCount: filteredWork.length,
                                      itemBuilder: (context, index) {
          
                                        var imageurl = filteredWork[index].imageUrl;
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Text(
                                                    filteredWork[index].author_info,
                                                  ),
                                                  Text(
                                                    filteredWork[index].date,
                                                  ),
                                                ],
                                              ),
                                            )
          ...
          /////////////////////////
                    ...
                    const Positioned(
                        ...
                        child: Padding(
                            ...
                            child:Center(child: Text(' العمل',style:  TextStyle(fontSize: 25,color: Colors.black, fontFamily: 'el-messiri-cufonfonts',),textDirection: TextDirection.rtl,))
                        )
                    ),
                  ],
                ),
