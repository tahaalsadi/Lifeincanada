...
class _TourismState extends State<Tourism> {
  ...
  void initState() {
    ...
    TresutService.getTresut().then((tresutFromServer) {
      setState(() {
         tresut = tresutFromServer;
        filteredTresut = tresut;
      });
    });
  }
  @override
                          ...
                          Expanded(
                            child:  DraggableScrollbar.semicircle(
                              ...
                              child: ListView.builder(
                                          ...
                                          itemCount: filteredTresut.length,
                                          itemBuilder: (context, index) {
                                            var imageurl = filteredTresut[index].imageUrl;
                                            ...
                                            return Card(
                                              ...
                                              child: Column(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Text(
                                                    filteredTresut[index].author_info,
                                                  ),
                                                  Text(
                                                    filteredTresut[index].date,
                                                  ),
                                                ],
                                              ),
                                            ));
          ...
          /////////////////////////
                 ...
                 const Positioned(
                    ...
                    child: Padding(
                      ...
                      child: Center(child: Text('السياحة',style:  TextStyle(fontSize: 25,color: Colors.black, fontFamily: 'el-messiri-cufonfonts',),textDirection: TextDirection.rtl,))
                    )
                ),                                       
                    ],
                  ),
