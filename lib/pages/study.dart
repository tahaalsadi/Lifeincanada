...
import 'package:lifeincanadalast/servises/study_services.dart';
import 'package:lifeincanadalast/static/main_darwer.dart';
import 'package:readmore/readmore.dart';

class Study extends StatefulWidget {
  static const route = '/Study';
...
class _StudyState extends State<Study> {
  ...
  void initState() {
    ...
    StudyServices.getStudy().then((studyFromServer) {
      setState(() {
        study = studyFromServer;
        filteredStudy = study;
      });
    });
  }
                          ...
                          Expanded(
                            child:  DraggableScrollbar.semicircle(
                              ...
                              child: ListView.builder(
                                          ...
                                          itemCount: filteredStudy.length,
                                          itemBuilder: (context, index) {
                                            var imageurl = filteredStudy[index].imageUrl;
                                            ...
                                            return Card(
                                              ...
                                              child: Column(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Text(
                                                    filteredStudy[index].author_info,
                                                  ),
                                                  Text(
                                                    filteredStudy[index].date,
                                                  ),
                                                ],
                                              ),
                                            ));
          ...
          /////////////////////////
                 ...
                 const Positioned(
                    ...
                    child: Padding(
                      ...
                      child: Center(child: Text('الدراسة',style:  TextStyle(fontSize: 25,color: Colors.black, fontFamily: 'el-messiri-cufonfonts',),textDirection: TextDirection.rtl,))
                    )
                ),                                       
                    ],
                  ),
